        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text('Error'),
              content: Text(
                  'An appointment already exists for ${DateFormat('MMMM d, y').format(selectedDate)}.'),
              actions: [
                TextButton(
                  onPressed: () {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(
                'Your appointment with $doctorName on ${DateFormat('MMMM d, y').format(selectedDate)} has been confirmed.'),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop(); // Close the dialog
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                    height:
                        20), // Add space between the calendar and the button
                ElevatedButton(
                  onPressed: () {
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    side: BorderSide(
                      color:
                          Colors.white, // Optional: Add a border to the button
                      width: 2,
                    ),
